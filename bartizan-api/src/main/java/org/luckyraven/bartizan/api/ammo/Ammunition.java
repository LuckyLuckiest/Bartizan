...
public class Ammunition implements Comparable<Ammunition> {
	 ...
	 * resolve configured PlaceholderAPI placeholders in the display name and lore.
	 */
	@Setter
	@Nullable
	...
	public static Ammunition getHeldAmmunition(AmmunitionCatalog ammunitionManager, ItemStack itemHeld) {
