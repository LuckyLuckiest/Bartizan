 ...
 * plugin on the shared classloader. {@code Bartizan.onDisable()} must never call it, or disabling/reloading
 * Bartizan silently downgrades recoil/packet handling to a no-op for every OTHER plugin still running.
 */
