...
/**
 * Duplicate of {@code bartizan-api}'s {@code WeaponFixtures} (bartizan.md §3: "duplicate if both modules need it")
 * — {@code bartizan-plugin} tests (e.g. {@code WeaponServiceTest}) need the same minimal weapon factories but
 * cannot depend on {@code bartizan-api}'s test-jar.
 */
