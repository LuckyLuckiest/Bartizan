 ...
 *
 * <p><b>Package note (bartizan.md §3, GD review m7):</b> lives in {@code org.luckyraven.bartizan.raytrace}
 * (the plugin module, not the api) because {@code SteppedProjectileTask} itself moved there at the GD-review
 * amendment M1 — {@code falloffDamage} is package-private, so this test must share its package.
 */
